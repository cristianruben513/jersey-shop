    ...
    >
      <div className="flex items-center justify-between gap-4">
        ...
        >
          <Link href={href}>
            {linkText}
            <ArrowRightIcon 
              className="ml-2 size-4 group-hover:-rotate-45 transition-transform duration-300 ease-in-out"
              aria-hidden="true"
            />
      ...
      <div className="space-y-8">
        ...
        >
          <Link href={href}>
            {linkText}
            <ArrowRightIcon className="ml-2 size-4 group-hover:rotate-45" aria-hidden="true" />
            <span className="sr-only"> {linkText}</span>
          </Link>
        </Button>
      </div>
